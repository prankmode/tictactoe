...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameUiEvents = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onStats = function onStats() {
	  api.allMyGames().then(ui.statsSuccess).catch(ui.statsFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var allMyGames = function allMyGames() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var play = __webpack_require__(15);
	...
	var statsSuccess = function statsSuccess(data) {
	  ...
	  var finished = data.games.filter(function (n) {
	    return n.over === true;
	  }).length;
	  var howManyWins = 0;
	...
	var statsFailure = function statsFailure(error) {
	  console.error(error);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toggleStatsButton = function toggleStatsButton() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sayThis = function sayThis(sayWhat) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onClick = function onClick(event) {
	  ...
	  var gameOver = gameState.checkForWinner();
	  if (gameOver) {
	    // winner!
	...
	var playGame = function playGame(data) {
	  ...
	  for (var _i = 0; _i < boxes.length; _i++) {
	    boxes[_i].addEventListener('click', onClick);
	  }
	}; // playGame

	var checkForWin = function checkForWin(board, who) {
	  ...
	  // check diags
	  if (!b[4]) {
	    // if you don't own the middle square...
	    return false;
	  } else {
	    if (b[0] && b[8] || b[2] && b[6]) {
	      return true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(pos, val, gameOver) {
	  return $.ajax({
